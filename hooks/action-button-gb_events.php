...
return '
<a href="'.routeTo('guestbook/screen',['filter'=>['event_id' => $data->id]]).'" class="btn btn-sm btn-secondary" target="_blank"><i class="mdi mdi-crop-free"></i> '.__('guestbook.label.screen').'</a> 
